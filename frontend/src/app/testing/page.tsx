...
export default function TestingPage() {
 ...
 <div className="flex items-center gap-2 rounded-2xl border border-border/70 bg-background/70 px-4 py-3 text-xs text-muted-foreground shadow-sm ">
 ...
 onDrop={onDrop}
 className={cn(
 "group relative cursor-pointer overflow-hidden rounded-2xl border-2 border-dashed px-6 py-12 transition-colors",
 dragOver
 ...
 : "bg-muted text-muted-foreground group-hover:bg-foreground group-hover:text-primary-foreground"
 )}
 >
 ...
 size="sm"
 onClick={clearFile}
 className="h-7 gap-1.5 rounded-md text-[11px] text-muted-foreground hover:bg-muted hover:text-foreground"
 >
 <X className="size-3" />
 Clear
 </Button>
 ...
 className={cn(
 "group relative overflow-hidden rounded-xl border-2 bg-card p-4 text-left transition-colors",
 isActive
 ? "border-primary shadow-sm"
 : "border-border/80 hover:border-foreground/15"
 )}
 >
 {isActive && (
 ...
 <div className={cn(iconBox("md"), "mb-3")}>
 ...
 className="resize-y rounded-xl border-2 focus-visible:ring-ring/50"
 />
 </div>
 )}
 ...
 className="flex h-11 w-full rounded-xl border-2 border-input bg-background px-4 py-2 text-sm font-medium focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-ring/50"
 >
 ...
 className="h-14 w-full gap-2 rounded-2xl bg-card hover:shadow-2xl disabled:bg-none disabled:bg-muted disabled:text-muted-foreground disabled:shadow-none"
 >
 {status === "running" ? (
 <>
 ...
 <div className="p-6">
 {status === "idle" && (
 <div className="flex h-[28rem] flex-col items-center justify-center rounded-xl border-2 border-dashed border-border bg-muted/20">
 ...
 {status === "running" && (
 <div className={cn(rh.card, "space-y-4 p-5")}>
 <div className="flex items-center gap-3">
 ...
 {status === "failed" && (
 <div className={cn(rh.card, "flex h-[28rem] flex-col items-center justify-center p-6")}>
 <div className={cn(iconBox("lg"), "mb-4")}>
 <X className="size-7" />
 </div>
 <p className="text-base font-bold text-destructive">Processing failed</p>
 ...
 <Tile label="Words" value={stats.words.toLocaleString()} />
 )}
 ...
 <pre className="whitespace-pre-wrap p-5 font-mono text-sm leading-relaxed text-primary-foreground">
 {activeText}
 </pre>
 </ScrollArea>
 </div>
